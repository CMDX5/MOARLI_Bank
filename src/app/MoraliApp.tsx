...
.legal-modal::-webkit-scrollbar{display:block;width:4px}
.legal-modal::-webkit-scrollbar-track{background:transparent}
.legal-modal::-webkit-scrollbar-thumb{background:rgba(212,164,55,.3);border-radius:10px}
.legal-modal::-webkit-scrollbar-thumb:hover{background:rgba(212,164,55,.5)}
.legal-modal{scrollbar-width:thin;scrollbar-color:rgba(212,164,55,.3) transparent}

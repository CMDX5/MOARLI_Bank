        ...
        <div className="balance-card">
          ...
          <div className="bc-stats">
            <div className="bc-stat">
              ...
              <div className="bc-stat-v up">{weeklyStats.income > 0 ? formatStat(weeklyStats.income, "credit") : "0 FCFA"}</div>
            </div>
            <div className="bc-stat">
              <div className="bc-stat-l">Dépenses</div>
              <div className="bc-stat-v dn">{weeklyStats.expenses > 0 ? formatStat(weeklyStats.expenses, "debit") : "0 FCFA"}</div>
            </div>
            <div className="bc-stat">
